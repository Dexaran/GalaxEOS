...
using namespace eosio;
    ...
    const double   gas_per_distance  = 0.2; // Global multiplier of gas comsumption.
    const double   time_scale        = 0.1;  // Global multiplier applied to each time-consuming process.
